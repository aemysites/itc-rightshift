...
## Environments
- Preview: https://main--itc-rightshift--aemysites.aem.page/
- Live: https://main--itc-rightshift--aemysites.aem.live/
- Block Library: https://main--itc-rightshift--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-rightshift` directory in your favorite IDE and start coding :)
